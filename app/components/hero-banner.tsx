...
const HeroBanner = () => {
  return (
    <div className="relative w-full flex flex-col min-h-72 lg:min-h-[22rem]">
      ...
      <div className="z-10 flex flex-col gap-4 absolute h-full items-start justify-end px-12 pb-2 lg:pb-8 lg:px-28 xl:px-44 lg:max-w-[44rem] xl:max-w-[60rem]">
